...
namespace Offsets
{
	constexpr int32 GObjects          = 0x02DEE120;
	constexpr int32 AppendString      = 0x00689A10;
	constexpr int32 GNames            = 0x0315D630;
	constexpr int32 GWorld            = 0x03261B70;
	constexpr int32 ProcessEvent      = 0x00829D50;
