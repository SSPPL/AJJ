...
// WidgetBlueprintGeneratedClass WB_ArrowButton_U.WB_ArrowButton_U_C
// 0x0070 (0x0310 - 0x02A0)
class UWB_ArrowButton_U_C final : public UAJBButtonWidget
{
public:
...
public:
	void ExecuteUbergraph_WB_ArrowButton_U(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("WB_ArrowButton_U_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"WB_ArrowButton_U_C")
	}
	static class UWB_ArrowButton_U_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWB_ArrowButton_U_C>();
	}
};
DUMPER7_ASSERTS_UWB_ArrowButton_U_C;
