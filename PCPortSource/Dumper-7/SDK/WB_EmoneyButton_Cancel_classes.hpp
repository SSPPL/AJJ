...
// WidgetBlueprintGeneratedClass WB_EmoneyButton_Cancel.WB_EmoneyButton_Cancel_C
// 0x0028 (0x02C8 - 0x02A0)
class UWB_EmoneyButton_Cancel_C final : public UAJBButtonWidget
{
public:
...
public:
	...
	void ExecuteUbergraph_WB_EmoneyButton_Cancel(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("WB_EmoneyButton_Cancel_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"WB_EmoneyButton_Cancel_C")
	}
	static class UWB_EmoneyButton_Cancel_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWB_EmoneyButton_Cancel_C>();
	}
};
DUMPER7_ASSERTS_UWB_EmoneyButton_Cancel_C;
