...
// BlueprintGeneratedClass BP_AJBOutGameEffectPoolManager.BP_AJBOutGameEffectPoolManager_C
// 0x00E0 (0x0418 - 0x0338)
class ABP_AJBOutGameEffectPoolManager_C final : public AAJBInGameEffectPoolManager
{
public:
...
public:
	void ExecuteUbergraph_BP_AJBOutGameEffectPoolManager(int32 EntryPoint);
	...
	bool ShouldSpawnGionIn3DWorldSpace(const struct FGameplayTag& EffectType, class AActor* Owner_0, E_GionSpawnedSpace GionSpawnedSpaceInOwnersEnv, E_GionSpawnedSpace GionSpawnedSpaceInNotOwnersEnv);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_AJBOutGameEffectPoolManager_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_AJBOutGameEffectPoolManager_C")
	}
	static class ABP_AJBOutGameEffectPoolManager_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_AJBOutGameEffectPoolManager_C>();
	}
};
DUMPER7_ASSERTS_ABP_AJBOutGameEffectPoolManager_C;
