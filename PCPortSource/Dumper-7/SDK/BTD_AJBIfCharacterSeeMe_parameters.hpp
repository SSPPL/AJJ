...
struct BTD_AJBIfCharacterSeeMe_C_PerformConditionCheckAI final
{
public:
	...
	bool                                          CallFunc_AIIfCharacterPossiblySeeMe_ReturnValue;   // 0x0031(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
DUMPER7_ASSERTS_BTD_AJBIfCharacterSeeMe_C_PerformConditionCheckAI;
