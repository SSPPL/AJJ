...
DUMPER7_ASSERTS_BP_AJBPairRescue_C_GetText;

// Function BP_AJBPairRescue.BP_AJBPairRescue_C.CheckInteractable
// 0x0020 (0x0020 - 0x0000)
struct BP_AJBPairRescue_C_CheckInteractable final
{
public:
	...
	bool                                          bTempInteractableBoth;                             // 0x0015(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          bTempInteractableParent;                           // 0x0016(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_CheckInteractable_bInteractable;          // 0x0017(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
DUMPER7_ASSERTS_BP_AJBPairRescue_C_CheckInteractable;
