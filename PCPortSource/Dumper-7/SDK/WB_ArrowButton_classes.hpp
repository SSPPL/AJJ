...
// WidgetBlueprintGeneratedClass WB_ArrowButton.WB_ArrowButton_C
// 0x0070 (0x0310 - 0x02A0)
class UWB_ArrowButton_C final : public UAJBButtonWidget
{
public:
...
public:
	void ExecuteUbergraph_WB_ArrowButton(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("WB_ArrowButton_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"WB_ArrowButton_C")
	}
	static class UWB_ArrowButton_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWB_ArrowButton_C>();
	}
};
DUMPER7_ASSERTS_UWB_ArrowButton_C;
