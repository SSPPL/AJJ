...
// WidgetBlueprintGeneratedClass WB_Aura_Card.WB_Aura_Card_C
// 0x0020 (0x0228 - 0x0208)
class UWB_Aura_Card_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_WB_Aura_Card(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("WB_Aura_Card_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"WB_Aura_Card_C")
	}
	static class UWB_Aura_Card_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWB_Aura_Card_C>();
	}
};
DUMPER7_ASSERTS_UWB_Aura_Card_C;
